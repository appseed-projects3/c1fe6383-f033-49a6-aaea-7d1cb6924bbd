...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-01-05 12:59`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c1fe6383-f033-49a6-aaea-7d1cb6924bbd.git
$ cd c1fe6383-f033-49a6-aaea-7d1cb6924bbd
```
